            ...
            for adj_dir in adj_dirs:
                ...
                if s_grid[temp_i][temp_j].isdigit() and \
                   memo[temp_i][temp_j] == 0:
                    ...
                    adj_part_nums.append("".join(s_grid[temp_i][num_start:(1 + num_end)]))
            if len(adj_part_nums) == 2:
                gear_ratios.append( int(adj_part_nums[0]) * int(adj_part_nums[1])  )                
...
if __name__ == "__main__":
    ...
    print ( "Sum of Gear Ratios:", sum( map( int, find_parts(schematic_grid) ) ) )
